...
<head>
  ...
  <link href="{{ asset('assets/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css') }}" rel="stylesheet" media="all">
                ...
                <a class="js-arrow" href="#">
                 ...
                 <ul class="list-unstyled navbar__sub-list js-sub-list" style="display:{{Request::routeIs('master*') ? 'block' : '' }}">
                  ...
                  <li class="{{Request::routeIs('master.stall*') ? 'active' : '' }}">
                   ...
                   <li class="{{Request::routeIs('master.employeer*') ? 'active' : '' }}">
                    <a href="/master/employeer">Karyawan</a>
                  </li>
                </ul>
              </li> 
                  ...
                  <div class="header-wrap">
                    ...
                    <div class="main-content">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="copyright">
                            <p>Copyright © 2020 CodeOnTop. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                          </div>
                        </div>
                      </div>
                    </div>
