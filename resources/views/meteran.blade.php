				...
				<form action="{{ route('meteran.store') }}" method="post">
					...
					<div class="form-group">
						<table class="table table-bordered">
							<tr>
								<td colspan="2">Meteran Listrik <span id="electricity_meter_code"
										style="font-weight: "></span></td>
							</tr>
							<tr>
								<td>Stand Awal</td>
								<td>Stand Akhir</td>
					...
					<div class="form-group">
						<table class="table table-bordered">
							<tr>
								<td colspan="2">Meteran Air <span id="electricity_meter_code"
							...
							<tr>
								<td><input type="number" name="water_meter_before" placeholder="...." value="0"
										class="form-control"></td>
								<td><input type="number" name="water_meter_after" placeholder="...." value="0"
										class="form-control"></td>
							</tr>
						</table>
					</div>
